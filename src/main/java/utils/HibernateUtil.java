...
public class HibernateUtil {
	 ...
	 */
	/*
	 * public static Session getSession() { if (sessionFactory == null) { session =
	 ...
	 *//**
		 ...
		 *//*
			 ...
			 * ThreadLocalSessionContext.unbind(sessionFactory); if (session != null) {
			 * session.close(); } closeSessionFactory(); }
			 */
